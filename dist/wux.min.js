var __spreadArray=this&&this.__spreadArray||function(t,e,n){if(n||2===arguments.length)for(var r,i=0,o=e.length;i<o;i++)!r&&i in e||(r||(r=Array.prototype.slice.call(e,0,i)),r[i]=e[i])
return t.concat(r||Array.prototype.slice.call(e))},__extends=this&&this.__extends||function(){var t=function(e,n){return(t=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(t,e){t.__proto__=e}||function(t,e){for(var n in e)Object.prototype.hasOwnProperty.call(e,n)&&(t[n]=e[n])})(e,n)}
return function(e,n){function r(){this.constructor=e}if("function"!=typeof n&&null!==n)throw new TypeError("Class extends value "+String(n)+" is not a constructor or null")
...
s!=e&&(r+=s+" ")}return r.trim()}function W(t,e){if(!t)return e
if(!e)return t
...
return i&&i.length?i:e.parent()}}function L(t,e,n,r){if(void 0===e&&(e=!0),void 0===n&&(n=!1),t){if(r&&"object"==typeof r){var i=""
...
for(var s=this.createEvent(t,o),a=0,l=this.handlers[t];a<l.length;a++){(0,l[a])(s)}}else this.root&&this.root.length&&(this.debug&&console.log("["+f(this)+"] trigger "+t+" on root="+f(this.root)),(e=this.root).trigger.apply(e,__spreadArray([t],r,!1)))
return this.internal&&(this.debug&&console.log("["+f(this)+"] trigger "+t+" on internal="+f(this.internal)),(n=this.internal).trigger.apply(n,__spreadArray([t],r,!1))),this}},e.prototype.unmount=function(){if(this.debug&&console.log("["+f(this)+"] unmount ctx="+f(this.context)+" root="+f(this.root),this.state,this.props),this.componentWillUnmount(),this.internal&&this.internal.unmount(),this.internal=void 0,this.root&&this.root.length&&this.root.remove(),this.root=void 0,this.id){var e=t.registry.indexOf(this.id)
...
var n=Math.floor(t/1e4),r=Math.floor(t%1e4/100),i=t%1e4%100,o=r<10?"0"+r:""+r,s=i<10?"0"+i:""+i
return n+":"+o+":"+s}t>9999&&(t=Math.floor(t/100))
var n=Math.floor(t/100),r=t%100,o=r<10?"0"+r:""+r
return n+":"+o}if("string"==typeof t){var a=t.indexOf("T")
...
return l+":"+h+":"+s}return l+":"+h}return""}function v(e,n,r,i){if(""===e||null==e)return""
...
var L="@D:=E?('B;F)<=A>C@?):D';@=B<?C;)E:'@=?A(B<=;(?@>E:"
...
return h.updateState(n),h.rootTag="a",h._href=a,h._target=l,h}return __extends(n,e),Object.defineProperty(n.prototype,"icon",{get:function(){return this.props},set:function(t){this.update(t,this.state,!0,!1,!1)},enumerable:!1,configurable:!0}),Object.defineProperty(n.prototype,"href",{get:function(){return this._href},set:function(t){this._href=t,this.root&&this.root.length&&(t?this.root.attr("href",t):this.root.removeAttr("href"))},enumerable:!1,configurable:!0}),Object.defineProperty(n.prototype,"target",{get:function(){return this._target},set:function(t){this._target=t,this.root&&this.root.length&&(t?this.root.attr("target",t):this.root.removeAttr("target"))},enumerable:!1,configurable:!0}),n.prototype.render=function(){var e=""
...
e==this.state?t+='<li class="active"><a data-toggle="tab" class="active" href="#'+this.id+"-"+e+'" aria-expanded="true"> '+n.name+"</a></li>":t+='<li><a data-toggle="tab" href="#'+this.id+"-"+e+'"> '+n.name+"</a></li>"}t+="</ul>",t+='<div class="tab-content">'
...
n.length&&(this._tooltip&&n.attr("title",this._tooltip))}},enumerable:!1,configurable:!0}),n.prototype.select=function(t){return this.root&&this.options?(this.setState(this.options.length>t?this.options[t]:null),this):this},n.prototype.render=function(){var e=""
...
if(this.root.find("tbody tr").removeClass(this.selClass),!this.handlers._selectionchanged)return this
...
for(var e=[],n=0,r=t;n<r.length;n++){var i=r[n]
this.root.find("tbody tr:eq("+i+")").addClass(this.selClass),this.state&&this.state.length>i&&e.push(this.state[i])}if(!this.handlers._selectionchanged)return this
for(var o=0,s=this.handlers._selectionchanged;o<s.length;o++){(0,s[o])({element:this.root,selectedRowsData:e})}return this},n.prototype.selectAll=function(t){if(!this.mounted)return this
if(t&&this.selectedRow>=0)return this.clearSelection()
if(this.selectedRow=-1,this.state&&this.state.length&&(this.selectedRow=0),this.root.find("tbody tr").addClass(this.selClass),!this.handlers._selectionchanged)return this
for(var e=0,n=this.handlers._selectionchanged;e<n.length;e++){(0,n[e])({element:this.root,selectedRowsData:this.state})}return this},n.prototype.getSelectedRows=function(){return this.mounted?this.selectedRow<0?[]:[this.selectedRow]:[]},n.prototype.getSelectedRowsData=function(){return this.mounted?this.selectedRow<0?[]:this.state&&this.state.length?this.state.length<=this.selectedRow?[]:[this.state[this.selectedRow]]:[]:[]},n.prototype.getFilteredRowsData=function(){return this.state},n.prototype.refresh=function(){return this},n.prototype.getCellValue=function(e,n){if(e<0||n<0)return null
...
var n=this.style?' style="'+this.style+'"':"",r='<div class="table-responsive"'+t.buildCss(this.divStyle)+'><table id="'+this.id+'" class="'+e+'"'+n+">"
...
var t=this
this.root.on("click","tbody tr",function(e){if(t.selectionMode&&"none"!=t.selectionMode){var n=$(this)
n.addClass(this.selClass).siblings().removeClass(this.selClass),t.selectedRow=n.index()
...
i.enabled=t,this.mounted&&(i.component?i.component.enabled=t:$("#"+i.id).prop("disabled",!t))}},enumerable:!1,configurable:!0}),n.prototype.setEnabled=function(t,e){if("string"==typeof t){var n=this.getField(t)
if(!n)return this
...
break
case t.WInputType.CheckBox:if(!this.checkboxStyle){var T=Math.round(.8*parseInt(this.root.css("font-size")));(isNaN(T)||T<16)&&(T=16),this.checkboxStyle="height:"+T+"px;"}this.checkboxStyle.length>2?p.element=$('<input type="checkbox" name="'+p.id+'" id="'+p.id+'" class="'+this.inputClass+'" style="'+this.checkboxStyle+'"/>'):p.element=$('<input type="checkbox" name="'+p.id+'" id="'+p.id+'" class="'+this.inputClass+'"/>')
break
case t.WInputType.Radio:p.component&&p.component.mount(f)
break
case t.WInputType.Select:var I=""
if(p.attributes?(I+='<select name="'+p.id+'" id="'+p.id+'" class="'+this.inputClass+'" '+p.attributes,(p.readonly||0==p.enabled)&&(I+=" disabled"),I+=">"):(I+='<select name="'+p.id+'" id="'+p.id+'" class="'+this.inputClass+'"',(p.readonly||0==p.enabled)&&(I+="disabled"),I+=">"),p.options&&p.options.length>0)for(var W=0;W<p.options.length;W++){var R=p.options[W]
I+="string"==typeof R?"<option>"+R+"</option>":'<option value="'+R.id+'">'+R.text+"</option>"}I+="</select>",p.element=$(I)
break
case t.WInputType.Email:var D='<input type="text" name="'+p.id+'" id="'+p.id+'" class="'+this.inputClass+'" '
...
n.indexOf(",00")>=0&&n.indexOf(",00")==n.length-3&&(n=n.substring(0,n.length-3)),n.indexOf(",0")>=0&&n.indexOf(",0")==n.length-2&&(n=n.substring(0,n.length-3)),this.value=n,$(this).select()}}),"c"==p.valueType?p.element.blur(function(e){this.value&&(this.value=t.formatCurr(t.WUtil.toNumber(this.value)))}):p.element.blur(function(e){this.value&&(this.value=t.formatCurr5(t.WUtil.toNumber(this.value)))})):"n"==p.valueType?(p.element.focus(function(e){this.value&&(this.value=t.formatNum(this.value),$(this).select())}),p.element.blur(function(e){this.value&&(this.value=t.formatNum(this.value))})):"i"==p.valueType?(p.element.focus(function(e){this.value&&(this.value=t.WUtil.toInt(this.value),$(this).select())}),p.element.blur(function(e){this.value&&(this.value=t.WUtil.toInt(this.value))})):p.element.focus(function(t){$(this).select()})),null==p.visible||p.visible||(p.element.hide(),p.label&&$('label[for="'+p.id+'"]').hide()),p.onmount&&p.onmount(p),p.onfocus&&p.element.focus(p.onfocus),p.onblur&&p.element.blur(p.onblur))}}}for(var E=0,k=this.hiddens;E<k.length;E++){var p=k[E]
null==p.value&&(p.value=""),this.root.append('<input type="hidden" name="'+p.id+'" id="'+p.id+'" value="'+p.value+'">')}if(this.footer&&this.footer.length>0){var N=t.style(this.footerStyle)
if(this.footerClass||(this.footerClass="col-md-12"),N=N?' style="'+N+'"':' style="text-align:right;"',this.footerSep)if("string"==typeof this.footerSep){var L=this.footerSep.charAt(0)
"<"==L?this.root.append(this.footerSep):t.WUtil.isNumeric(L)&&this.root.append('<div style="height:'+this.footerSep+'px;"></div>')}else this.root.append('<div style="height:'+this.footerSep+'px;"></div>')
var M=$('<div class="row"></div>')
this.root.append(M)
var U=$('<div class="'+this.footerClass+'"'+N+"></div>")
M.append(U)
for(var F=0,P=this.footer;F<P.length;F++){var H=P[F]
"string"==typeof H&&H.length>0?U.append($(H)):H instanceof t.WComponent?H.mount(U):U.append(H)}}for(var B=this,V=0,j=this.dpids;V<j.length;V++){var X=j[V]
!function(n){var r=t.WUtil.getDate(B.minValues,n)
$("#"+n).datepicker({language:t.global.locale,todayBtn:"linked",keyboardNavigation:!1,forceParse:!1,calendarWeeks:!0,autoclose:!0,minDate:r}).on("changeDate",function(r){if(e.handlers._changedate)for(var i=0,o=e.handlers._changedate;i<o.length;i++){var s=o[i]
...
c>=19000101&&u>c&&(t.showWarning(t.RES.ERR_DATE),$(r.target).datepicker("setDate",l))}}}})}(X)}"object"==typeof this.state&&this.updateView(),this.root.find("input").keypress(function(t){if(13==t.which){for(var n=$(t.target).attr("id"),r=e.next(n);r&&!e.isFocusable(r);)r=e.next(r.id)
...
break
default:o.value=""}}if(this.dpids)for(var s=0,a=this.dpids;s<a.length;s++){var l=a[s]
$("#"+l).datepicker("setDate",null)}return this},n.prototype.select=function(t,e){if(!t)return this
...
if(o.required&&null==e[a])throw new Error(o.label+": obbligatorio")
if(o.size&&null!=e[a]&&e[a].length>o.size)throw new Error(o.label+": supera "+o.size+" caratteri")
if(o.type&&null!=e[a]){var l=null,h=null
switch(o.type==t.WInputType.Date&&(e[a]=t.WUtil.toDate(e[a])),o.type){case t.WInputType.Number:h=new RegExp("^\\d+\\.\\d{1,2}$|^\\d*$"),h.test(e[a])||(l=o.label+": "+e[a]+" non numerico")
break
case t.WInputType.Integer:h=new RegExp("^\\d*$"),h.test(e[a])||(l=o.label+": "+e[a]+" non intero")
break
case t.WInputType.Email:h=new RegExp(/^\w+@[a-zA-Z_]+?\.[a-zA-Z]{2,3}$/),h.test(e[a])||(l=o.label+": "+e[a]+" email non valida")}if(l)throw new Error(l)}}return e},n}(t.WComponent)
t.WFormPanel=g
