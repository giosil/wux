...
p.readonly&&(L+="readonly "),0==p.enabled&&(L+="disabled "),L+=" ></div>",L+='<script type="text/javascript">$(document).ready(function() {',L+='$("#cron_'+p.id+'").cron({'+k+'onChange: function() {$("#'+p.id+'").val($(this).cron("value"));},useGentleSelect: true});',L+='});<\/script><input type="hidden" name="'+p.id+'" id="'+p.id+'" />',p.element=$(L)
break
