...
return!r||r.length<2?[e,t.trim(),n]:(e+=r[0],2==r.length?[e,r[1],""]:(n+=r[2],[e,r[1],n]))}function f(t){if(t instanceof U){var e=t.name,n=t.id
...
var e=M.toString(t),n=0,r=e.length,i=0
...
o&&(o.indexOf(":")>0||(n+=o+" "))}}return n.trim()}function S(t){if(!t)return""
if("string"==typeof t)return t
if("object"==typeof t){var e=""
for(var n in t)e+=n+'="'+t[n]+'" '
return e.trim()}return""}function x(t){for(var e=[],n=1;n<arguments.length;n++)e[n-1]=arguments[n]
...
i&&t.addClass(i),r&&t.css(m(r))}return t}function E(t,e,n,r,i,o){if(!t)return""
e||(e=""),n||(n="")
var s=o?' title="'+o+'"':""
...
u&&(h+=" "+u),h+=">"
var p=d(n)
return h+=p[1],"input"==e?p[0]+h+p[2]:(h+="</"+e+">",p[0]+h+p[2])}function D(e,n,r,i){if(!e||!n)return e
...
return e.indexOf("#")<0&&(e="#"+e),t.getContainer($(e))}if(e instanceof U){var r=e.getContext()
...
if(n&&!a)return r
r.push(a)}return r},e.toArrayString=function(t,n){if(t instanceof U&&(t=t.getState()),null==t)return[]
var r=[]
...
o.push(e.toNumber(l))}return o},e.toObject=function(t,e){return t instanceof U&&(t=t.getState()),null==t?e:"object"==typeof t?t:e},e.toString=function(n,r){return void 0===r&&(r=""),n instanceof U&&(n=n.getState()),null==n?r:"string"==typeof n?n:n instanceof Date?t.formatDate(n):"object"==typeof n&&void 0!=n.id?e.toString(n.id,r):Array.isArray(n)&&n.length?e.toString(n[0],r):""+n},e.toText=function(t,n){return void 0===n&&(n=""),e.toString(t,n).replace("<","&lt;").replace(">","&gt;")},e.toNumber=function(t,n){if(void 0===n&&(n=0),t instanceof U&&(t=t.getState()),null==t)return n
...
return isNaN(i)?n:i},e.toInt=function(t,n){if(void 0===n&&(n=0),t instanceof U&&(t=t.getState()),null==t)return n
...
return isNaN(i)?n:i},e.toIntTime=function(t,n){if(void 0===n&&(n=0),t instanceof U&&(t=t.getState()),null==t)return n
...
t.WUtil=M,t.getId=e,t.firstSub=n,t.lastSub=r,t.getComponent=i,t.getRootComponent=o,t.setProps=s,t.getProps=a,t.setState=l,t.getState=h,t.newInstance=u,t.same=p,t.parse=c,t.divide=d,t.str=f,t.getTagName=g,t.match=b,t.hashCode=y,t.styleObj=m,t.style=v,t.addStyle=_,t.css=C,t.cls=w,t.attributes=S,t.ul=x,t.ol=O,t.buildCss=T,t.removeClass=I,t.toggleClass=W,t.setCss=R,t.buildIcon=E,t.build=A,t.addWrapper=D,t.val=k,t.getContainer=L,t.openURL=N}(WUX||(WUX={}))
var WUX
...
return a+":"+l+":"+s}return a+":"+l}return""}function v(e,n,r,i){if(null==e)return""
var o=t.WUtil.toNumber(e),s=(""+Math.round(100*o)/100).replace(".",",")
return null!=n&&0!=o?null!=i&&o<0?i.replace("$",s):n.replace("$",s):null!=r&&0==o?r.replace("$",s):s}function _(e,n,r,i){if(null==e)return""
var o=t.WUtil.toNumber(e),s=(""+o).replace(".",",")
return null!=n&&0!=o?null!=i&&o<0?"l"==i?o.toLocaleString("it-IT"):i.replace("$",s):"l"==n?o.toLocaleString("it-IT"):n.replace("$",s):null!=r&&0==o?r.replace("$",s):s}function C(e,n,r,i){if(null==e)return""
var o=t.WUtil.toNumber(e),s=(Math.round(100*o)/100).toLocaleString("it-IT"),a=s.indexOf(",")
return a<0&&(s+=",00"),a==s.length-2&&(s+="0"),null!=n&&0!=o?null!=i&&o<0?i.replace("$",s):n.replace("$",s):null!=r&&0==o?r.replace("$",s):s}function w(e,n,r,i){if(null==e)return""
...
s=u+h}return null!=n&&0!=o?null!=i&&o<0?i.replace("$",s):n.replace("$",s):null!=r&&0==o?r.replace("$",s):s}function S(t){return t?"S":"N"}function x(e){if(null==e)return""
...
if(Array.isArray(n)&&n.length>1){for(var r="",i=0,o=n;i<o.length;i++){var s=o[i],a=t.WUtil.toString(s)
if(a)if(a.length>9){var l=a.indexOf(" -")
l>0&&(a=a.substring(0,l).trim()),r+=","+a}else r+=","+a}return r.length&&(r=r.substring(1)),r}var a=t.WUtil.toString(e.getProps())
...
return r>0&&r<13?r:0}function W(e){return e?(e=t.WUtil.toString(e),e=e.replace("À","A'").replace("È","E'").replace("Ì","I'").replace("Ò","O'").replace("Ù","U'"),e=e.replace("à","a'").replace("è","e'").replace("ì","i'").replace("ò","o'").replace("ù","u'"),e=e.replace("á","a`").replace("é","e`").replace("í","i`").replace("ó","o`").replace("ú","u`"),e=e.replace("€","E").replace("ª","a").replace("°","o")):""}function R(e){return e?(e=t.WUtil.toString(e),e=e.replace("A'","À").replace("E'","È").replace("I'","Ì").replace("O'","Ò").replace("U'","Ù"),e=e.replace("a'","à").replace("e'","è").replace("i'","ì").replace("o'","ò").replace("u'","ù"),e=e.replace("a`","á").replace("e`","é").replace("i`","í").replace("o`","ó").replace("u`","ú"),e=e.replace(" pò"," po'")):""}function E(e){return e?(e=t.WUtil.toString(e),e=e.replace("&Agrave;","A'").replace("&Egrave;","E'").replace("&Igrave;","I'").replace("&Ograve;","O'").replace("&Ugrave;","U'"),e=e.replace("&agrave;","a'").replace("&egrave;","e'").replace("&igrave;","i'").replace("&ograve;","o'").replace("&ugrave;","u'"),e=e.replace("&aacute;","a`").replace("&eacute;","e`").replace("&iacute;","i`").replace("&oacute;","o`").replace("&uacute;","u`"),e=e.replace("&euro;","E").replace("&nbsp;"," ").replace("&amp;","&").replace("&gt;",">").replace("&lt;","<").replace("&quot;",'"')):""}function A(e){if(!e)return""
for(var n=t.WUtil.toString(e),r="",i=0,o=0;o<n.length;o++){i=i>=N.length-1?0:i+1
var s=n.charCodeAt(o),a=N.charCodeAt(i),l=s
s>=32&&s<=126&&(l-=a)<32&&(l=127+l-32),r+=String.fromCharCode(l)}return r}function D(e){if(!e)return""
for(var n=t.WUtil.toString(e),r="",i=0,o=0;o<n.length;o++){i=i>=N.length-1?0:i+1
var s=n.charCodeAt(o),a=N.charCodeAt(i),l=s
s>=32&&s<=126&&(l+=a)>126&&(l=31+l-126),r+=String.fromCharCode(l)}return r}var k={},L={}
...
var n=k[t]
return null==n?e:n},onDataChanged:function(t,e){t||(t="global"),L[t]||(L[t]=[]),L[t].push(e)}},t.showMessage=e,t.showInfo=n,t.showSuccess=r,t.showWarning=i,t.showError=o,t.confirm=s,t.getInput=a,t.getPageTitle=l,t.getBreadcrump=h,t.getPageHeader=u,t.getPageFooter=p,t.getPageMenu=c,t.getViewRoot=d,t.sticky=f,t.stickyRefresh=g,t.formatDate=b,t.formatDateTime=y,t.formatTime=m,t.formatNum2=v,t.formatNum=_,t.formatCurr=C,t.formatCurr5=w,t.formatBoolean=S,t.format=x,t.formatDay=O,t.formatMonth=T,t.decodeMonth=I,t.norm=W,t.den=R,t.text=E
var N="@D:=E?('B;F)<=A>C@?):D';@=B<?C;)E:'@=?A(B<=;(?@>E:"
t.encrypt=A,t.decrypt=D
...
"string"==typeof this.headStyle?this.headStyle.indexOf("text-align")>0&&(i=!0):this.headStyle&&this.headStyle.a&&(i=!0),r+=i?"<thead><tr>":"<thead><tr"+t.buildCss(this.headStyle)+">"
...
_(C,{data:o,text:g}),s.append(C)}else if(t.WUtil.hasComponents(g))for(var w=t.WUtil.toArrayComponent(g),S=0,x=w;S<x.length;S++){var O=x[S],C=$("<td"+t.buildCss(m,b,{w:v})+"></td>")
...
break
case t.WInputType.Note:var x='<textarea name="'+p.id+'" id="'+p.id+'" class="form-control" '
p.attributes&&(x+=p.attributes+" "),p.readonly&&(x+="readonly "),0==p.enabled&&(x+="disabled "),p.style&&(x+=' style="'+t.style(p.style)+'"'),x+="></textarea>",p.element=$(x)
break
...
break
case t.WInputType.Ftp:var E='<input type="text" name="'+p.id+'" id="'+p.id+'" class="'+this.inputClass+'" '
...
break
case t.WInputType.Cron:var D=""
null!=p.value&&""!=p.value&&(D='initial: "'+p.value+'" ,')
var k='<div id="cron_'+p.id+'" class="'+this.inputClass+'" '
p.readonly&&(k+="readonly "),0==p.enabled&&(k+="disabled "),k+=" ></div>",k+='<script type="text/javascript">$(document).ready(function() {',k+='$("#cron_'+p.id+'").cron({'+D+'onChange: function() {$("#'+p.id+'").val($(this).cron("value"));},useGentleSelect: true});',k+='});<\/script><input type="hidden" name="'+p.id+'" id="'+p.id+'" />',p.element=$(k)
break
...
F.append(P)
for(var H=0,V=this.footer;H<V.length;H++){var B=V[H]
"string"==typeof B&&B.length>0?P.append($(B)):B instanceof t.WComponent?B.mount(P):P.append(B)}}for(var j=this,G=0,X=this.dpids;G<X.length;G++){var z=X[G]
...
p>=19000101&&u<p&&(t.showWarning(t.MSG.INVALID_DATE),$(r.target).datepicker("setDate",a))
var c=t.WUtil.toInt(l)
c>=19000101&&u>c&&(t.showWarning(t.MSG.INVALID_DATE),$(r.target).datepicker("setDate",l))}}}})}(z)}"object"==typeof this.state&&this.updateView(),this.root.find("input").keypress(function(t){if(13==t.which){for(var n=$(t.target).attr("id"),r=e.next(n);r&&!e.isFocusable(r);)r=e.next(r.id)
