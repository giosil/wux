...
break
case t.WInputType.CheckBox:if(!this.checkboxStyle){var T=Math.round(.8*parseInt(this.root.css("font-size")))
T<16&&(T=16),this.checkboxStyle="height:"+T+"px;"}this.checkboxStyle.length>2?p.element=$('<input type="checkbox" name="'+p.id+'" id="'+p.id+'" class="'+this.inputClass+'" style="'+this.checkboxStyle+'"/>'):p.element=$('<input type="checkbox" name="'+p.id+'" id="'+p.id+'" class="'+this.inputClass+'"/>')
break
