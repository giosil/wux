...
return n&&(i+=' class="'+n+'"'),r&&(i+=' style="'+r+'"'),i}function W(t,e){if(!t||!e)return t
for(var n=t.split(" "),r="",i=0,o=n;i<o.length;i++){var s=o[i]
s!=e&&(r+=s+" ")}return r.trim()}function I(t,e){if(!t||!e)return t
...
s=u+h}return null!=n&&0!=o?null!=i&&o<0?i.replace("$",s):n.replace("$",s):null!=r&&0==o?r.replace("$",s):s}function x(t){return t?"S":"N"}function S(e){if(null==e)return""
...
case 12:return e?"Dicembre"+n:"Dic"+n}return""}function W(e){if(!e)return 0
...
return r>0&&r<13?r:0}function I(e){return e?(e=t.WUtil.toString(e),e=e.replace("À","A'").replace("È","E'").replace("Ì","I'").replace("Ò","O'").replace("Ù","U'"),e=e.replace("à","a'").replace("è","e'").replace("ì","i'").replace("ò","o'").replace("ù","u'"),e=e.replace("á","a`").replace("é","e`").replace("í","i`").replace("ó","o`").replace("ú","u`"),e=e.replace("€","E").replace("ª","a").replace("°","o")):""}function R(e){return e?(e=t.WUtil.toString(e),e=e.replace("A'","À").replace("E'","È").replace("I'","Ì").replace("O'","Ò").replace("U'","Ù"),e=e.replace("a'","à").replace("e'","è").replace("i'","ì").replace("o'","ò").replace("u'","ù"),e=e.replace("a`","á").replace("e`","é").replace("i`","í").replace("o`","ó").replace("u`","ú"),e=e.replace(" pò"," po'")):""}function D(e){return e?(e=t.WUtil.toString(e),e=e.replace("&Agrave;","A'").replace("&Egrave;","E'").replace("&Igrave;","I'").replace("&Ograve;","O'").replace("&Ugrave;","U'"),e=e.replace("&agrave;","a'").replace("&egrave;","e'").replace("&igrave;","i'").replace("&ograve;","o'").replace("&ugrave;","u'"),e=e.replace("&aacute;","a`").replace("&eacute;","e`").replace("&iacute;","i`").replace("&oacute;","o`").replace("&uacute;","u`"),e=e.replace("&euro;","E").replace("&nbsp;"," ").replace("&amp;","&").replace("&gt;",">").replace("&lt;","<").replace("&quot;",'"')):""}function A(e){if(!e)return""
for(var n=t.WUtil.toString(e),r="",i=0,o=0;o<n.length;o++){i=i>=N.length-1?0:i+1
var s=n.charCodeAt(o),a=N.charCodeAt(i),l=s
s>=32&&s<=126&&(l-=a)<32&&(l=127+l-32),r+=String.fromCharCode(l)}return r}function E(e){if(!e)return""
for(var n=t.WUtil.toString(e),r="",i=0,o=0;o<n.length;o++){i=i>=N.length-1?0:i+1
var s=n.charCodeAt(o),a=N.charCodeAt(i),l=s
...
var M=function(){function t(){}return t.OK="OK",t.CLOSE="Chiudi",t.CANCEL="Annulla",t.ERR_DATE="Data non ammessa.",t}()
t.RES=M}(WUX||(WUX={}))
var WUX
...
if(p.attributes?(T+='<select name="'+p.id+'" id="'+p.id+'" class="'+this.inputClass+'" '+p.attributes,(p.readonly||0==p.enabled)&&(T+=" disabled"),T+=">"):(T+='<select name="'+p.id+'" id="'+p.id+'" class="'+this.inputClass+'"',(p.readonly||0==p.enabled)&&(T+="disabled"),T+=">"),p.options&&p.options.length>0)for(var W=0;W<p.options.length;W++){var I=p.options[W]
T+="string"==typeof I?"<option>"+I+"</option>":'<option value="'+I.id+'">'+I.text+"</option>"}T+="</select>",p.element=$(T)
break
