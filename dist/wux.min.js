...
return null==e?this:(this.root.select2("val",e),this)},n.prototype.selectVal=function(t,e,n){if(!t||!t.length)return void this.root.val([]).trigger("change")
if(n){this.root.empty()
for(var i=0;i<t.length;i++){var o=e?e[i]:""+t[i]
this.root.append('<option value="'+t[i]+'">'+o+"</option>")}}this.root.select2("val",t)},n.prototype.setOptions=function(t){if(this.options=t,!this.root)return this
this.root.empty()
var e=[]
